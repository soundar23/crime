module.exports = function convertCsv(startYear) {
    ...
    rd.on('close', function() {
        ...
        fs.writeFileSync('barchart.json', JSON.stringify(firstcri)); /*converting the result into JSON and writing in JSON file first cri*/
        fs.writeFileSync('linechart.json', JSON.stringify(secondcri)); /*converting the result into JSON and writing in JSON file first cri*/
    });
